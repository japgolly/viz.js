...
VIZOPTS=-v -O0
#VIZOPTS=-v -O1 -s ASM_JS=1 --closure 1 --jcache
LIBOPTS=-O0
	#$(SRCDIR)/lib/cgraph/libcgraph-em.bc \

viz.js: $(SRCDIR) $(EPSRCDIR) viz.c $(LIBSBC) post.js pre.js
	$(EMCC) $(VIZOPTS) -s EXPORTED_FUNCTIONS='["_vizRenderFromString"]' -o viz.js -I$(SRCDIR)/lib/gvc -I$(SRCDIR)/lib/common -I$(SRCDIR)/lib/pathplan -I$(SRCDIR)/lib/cdt -I$(SRCDIR)/lib/graph -I$(SRCDIR)/lib/cgraph -I$(EPSRCDIR)/lib viz.c $(LIBSBC) --pre-js pre.js --post-js post.js
...
$(SRCDIR)/lib/common/libcommon-em.bc:
	cd $(SRCDIR)/lib/common; $(EMCC) $(LIBOPTS) -o libcommon-em.bc -I. -I.. -I../.. -I../../.. -I../gvc -I../pathplan -I../cdt -I../cgraph -I../graph -I../fdpgen -I../label -I../xdot -I../../../$(EPSRCDIR)/lib -DHAVE_CONFIG_H -DHAVE_EXPAT_H -DHAVE_EXPAT \
...
$(SRCDIR)/lib/gvc/libgvc-em.bc:
	cd $(SRCDIR)/lib/gvc; $(EMCC) $(LIBOPTS) -o libgvc-em.bc -I. -I.. -I../.. -I../../.. -I../common -I../cgraph -I../pathplan -I../cdt -I../graph -DHAVE_CONFIG_H \
...
$(SRCDIR)/lib/graph/libgraph-em.bc:
	cd $(SRCDIR)/lib/graph; $(EMCC) $(LIBOPTS) -o libgraph-em.bc -I. -I../cdt -I../gvc -I../common -I../cgraph -I../pathplan \
...
$(SRCDIR)/lib/cgraph/libcgraph-em.bc:
	cd $(SRCDIR)/lib/cgraph; $(EMCC) $(LIBOPTS) -shared -o libcgraph-em.bc -I. -I../cdt -I../../.. -DHAVE_CONFIG_H \
	apply.c attr.c edge.c \
...
$(SRCDIR)/lib/osage/libosage-em.bc:
	cd $(SRCDIR)/lib/osage; $(EMCC) $(LIBOPTS) -o libosage-em.bc -I. -I../gvc -I../common -I../cgraph -I../pathplan -I../cdt -I../graph -I../sparse -I../pack -I../neatogen osageinit.c

$(SRCDIR)/lib/pack/libpack-em.bc:
	cd $(SRCDIR)/lib/pack; $(EMCC) $(LIBOPTS) -o libpack-em.bc -I. -I../common -I../cgraph -I../neatogen -I../pathplan -I../graph -I../cdt -I../gvc ccomps.c pack.c

$(SRCDIR)/lib/sparse/libsparse-em.bc:
	cd $(SRCDIR)/lib/sparse; $(EMCC) $(LIBOPTS) -o libsparse-em.bc -I. -I../common -I../cgraph SparseMatrix.c general.c BinaryHeap.c IntStack.c

$(SRCDIR)/lib/patchwork/libpatchwork-em.bc:
	cd $(SRCDIR)/lib/patchwork; $(EMCC) $(LIBOPTS) -o libpatchwork-em.bc -I. -I../gvc -I../common -I../cgraph -I../pathplan -I../cdt -I../graph -I../fdpgen -I../sparse -I../neatogen -I../pack patchwork.c patchworkinit.c tree_map.c

$(SRCDIR)/lib/dotgen/libdotgen-em.bc:
	cd $(SRCDIR)/lib/dotgen; $(EMCC) $(LIBOPTS) -o libdotgen-em.bc -I. -I.. -I../.. -I../../.. -I../common -I../cgraph -I../gvc -I../pathplan -I../cdt -I../graph -DHAVE_CONFIG_H \
...
$(SRCDIR)/lib/circogen/libcircogen-em.bc:
	cd $(SRCDIR)/lib/circogen; $(EMCC) $(LIBOPTS) -o libcircogen-em.bc -I. -I.. -I../.. -I../../.. -I../common -I../cgraph -I../gvc -I../pathplan -I../cdt -I../graph -I../neatogen -I../sparse -I../pack -DHAVE_CONFIG_H block.c blockpath.c blocktree.c circpos.c circular.c circularinit.c deglist.c edgelist.c nodelist.c nodeset.c

$(SRCDIR)/lib/twopigen/libtwopigen-em.bc:
	cd $(SRCDIR)/lib/twopigen; $(EMCC) $(LIBOPTS) -o libtwopigen-em.bc -I. -I.. -I../.. -I../../.. -I../common -I../cgraph -I../gvc -I../pathplan -I../cdt -I../graph -I../neatogen -I../sparse -I../pack -DHAVE_CONFIG_H circle.c twopiinit.c

$(SRCDIR)/lib/fdpgen/libfdpgen-em.bc:
	cd $(SRCDIR)/lib/fdpgen; $(EMCC) $(LIBOPTS) -o libfdpgen-em.bc -I. -I.. -I../.. -I../../.. -I../common -I../cgraph -I../gvc -I../neatogen -I../pack -I../sparse -I../pathplan -I../cdt -I../graph -DHAVE_CONFIG_H  comp.c dbg.c grid.c fdpinit.c layout.c tlayout.c xlayout.c clusteredges.c

$(SRCDIR)/lib/neatogen/libneatogen-em.bc:
	cd $(SRCDIR)/lib/neatogen; $(EMCC) $(LIBOPTS) -o libneatogen-em.bc -I. -I.. -I../.. -I../../.. -I../common -I../cgraph -I../gvc -I../pack -I../ortho -I../rbtree -I../sfdpgen -I../sparse -I../pathplan -I../cdt -I../graph -DHAVE_CONFIG_H adjust.c circuit.c edges.c geometry.c heap.c hedges.c info.c neatoinit.c legal.c lu.c matinv.c memory.c poly.c printvis.c site.c solve.c neatosplines.c stuff.c voronoi.c stress.c kkutils.c matrix_ops.c embed_graph.c dijkstra.c conjgrad.c pca.c closest.c bfs.c constraint.c quad_prog_solve.c smart_ini_x.c constrained_majorization.c opt_arrangement.c overlap.c call_tri.c compute_hierarchy.c delaunay.c multispline.c

$(SRCDIR)/plugin/core/libgvplugin_core-em.bc:
	cd $(SRCDIR)/plugin/core; $(EMCC) $(LIBOPTS) -o libgvplugin_core-em.bc -I. -I.. -I../.. -I../../.. -I../../lib -I../../lib/common -I../../lib/gvc -I../../lib/pathplan -I../../lib/cdt -I../../lib/graph -I../../lib/cgraph -DHAVE_CONFIG_H \
	gvplugin_core.c \
	gvrender_core_dot.c \
	gvrender_core_fig.c \
	gvrender_core_map.c \
...
$(SRCDIR)/plugin/dot_layout/libgvplugin_dot_layout-em.bc:
	cd $(SRCDIR)/plugin/dot_layout; $(EMCC) $(LIBOPTS) -o libgvplugin_dot_layout-em.bc -I. -I.. -I../.. -I../../.. -I../../lib -I../../lib/common -I../../lib/gvc -I../../lib/pathplan -I../../lib/cdt -I../../lib/graph -I../../lib/cgraph -DHAVE_CONFIG_H gvplugin_dot_layout.c gvlayout_dot_layout.c

$(SRCDIR)/plugin/neato_layout/libgvplugin_neato_layout-em.bc:
	cd $(SRCDIR)/plugin/neato_layout; $(EMCC) $(LIBOPTS) -o libgvplugin_neato_layout-em.bc -I. -I.. -I../.. -I../../.. -I../../lib -I../../lib/common -I../../lib/gvc -I../../lib/pathplan -I../../lib/cdt -I../../lib/graph -I../../lib/cgraph -DHAVE_CONFIG_H gvplugin_neato_layout.c gvlayout_neato_layout.c
